module ShopAlgorithms
    ...
    function test1()
        ...
        println(result11)
        result12 = Algorithms.generate_active_schedules(instance1; suppress_warnings=true)
        println(result12)
        result13 = Algorithms.generate_active_schedules(instance1; machine_repetition=true)
        println(result13)
